# Generated by Django 4.2.5 on 2024-04-28 15:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('commune', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='_communes', to='app.commune')),
                ('province', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='_provinces', to='app.province')),
            ],
        ),
        migrations.CreateModel(
            name='Status',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('commune', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='communes', to='app.commune')),
                ('province', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='provinces', to='app.province')),
            ],
        ),
        migrations.CreateModel(
            name='UserProfile',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('quartier', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.quartier')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rue', models.CharField(blank=True, max_length=30, null=True)),
                ...
                ('relation_avec_chefs_de_menage', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.status')),
